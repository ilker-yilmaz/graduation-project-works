...
for i, tweet in enumerate(
        sntwitter.TwitterSearchScraper('Fırat Üniversitesi').get_items()):  # change the search term here
...
tweets_df2.to_csv('trial-dataset.csv', index=False)  # write to csv the dataframe
